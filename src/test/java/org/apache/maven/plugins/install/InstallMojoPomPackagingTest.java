...
public class InstallMojoPomPackagingTest {
    ...
    @Singleton
    @SuppressWarnings("unused")
    private ProjectManager createProjectManager(InternalSession session) {
    ...
    @Singleton
    @SuppressWarnings("unused")
    private ArtifactManager createArtifactManager(InternalSession session) {
    ...
    @Singleton
    @SuppressWarnings("unused")
    private ArtifactInstaller createArtifactInstaller(InternalSession session) {
